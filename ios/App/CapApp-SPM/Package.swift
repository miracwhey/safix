...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorCommunityAppleSignIn", path: "../../../packages/capacitor-apple-signin"),
        ...
        .package(name: "FixupCapacitorRoomplan", path: "../../../packages/capacitor-roomplan"),
    ...
    targets: [
        .target(
            ...
            dependencies: [
                ...
                .product(name: "FixupCapacitorRoomplan", package: "FixupCapacitorRoomplan"),
